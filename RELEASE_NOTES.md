...
- A new quarterly business review includes fictional sales data, live formulas, two native Excel charts, five prepared export rows and instructions.
- A completed business presentation and matching optional Pro template replace the old template files in the installer.
- Every Demo menu action has a matching blue icon, including the examples folder and fresh-copy commands.
- Dimension Finder with two-decimal placement values.
- Export preflight, clear setup guidance and highlighted review warnings.
- Free/Pro comparison, a gold upgrade crown and a single Get Pro checkout.
- License activation with Personal and Team device allowances.

Pro adds larger exports, templates, editable and linked charts, text replacement and updating the open presentation. Personal and Team have the same features. Exceeding the Free limit stops the export and explains how to reduce the selection or upgrade.

## Install or update

Save your work, close Excel, and run **Excel2PPT-Setup.exe**. Reopen Excel and select **Excel2PPT > Demo > Open demo workbook**. Click **Export** for its first five-slide presentation. Run this installer to update an earlier 1.0.0 installation.
